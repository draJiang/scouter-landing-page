      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            ...
            <li>
              <a href="https://chromewebstore.google.com/detail/mncfcjnabpfoagocanfjglfcpmmnkicb" target='__blank' className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 w-full my-2" onClick={() => setMobileNavOpen(false)}>
